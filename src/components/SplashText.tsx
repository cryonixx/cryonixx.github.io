    ...
    return (
        <div>
            ...
            <p className="font-vt323">
                ...
                freely show my creations, show cool stuff I like, and more
                importantly, as a portfolio. Feel free to look around!! You
                might find something interesting and fun ^__^ Enjoy your stay~
                <br></br>
                <br></br>
